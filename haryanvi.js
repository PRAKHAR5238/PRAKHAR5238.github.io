const music = new Audio("audio/haryanvi/1.mp3");
let index = 24;
let previndex = 24;
...
const song = [
  {
    ...
    poster: "img/haryanvi/1.png",
  },
  {
    id: 2,

    songName: `Bhau Kale ki 
    
        <br>
        <div class="subtitle"></div>`,
    poster: "img/haryanvi/2.png",
  },
  {
    id: 3,

    songName: `Kamr Teri Left Right
        <br>
        <div class="subtitle">
</div>`,
    poster: "img/haryanvi/3.png",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    poster: "img/haryanvi/5.png",
  },
  {
    id: 6,

    songName: `Dhai litar Dudh
        <br>
        <div class="subtitle"> </div>`,
    poster: "img/haryanvi/6.png",
  },
  {
    id: 7,
  ...
  },
  {
    ...
    songName: `Balam
        <br>
        <div class="subtitle"></div>`,
    poster: "img/haryanvi/13.png",
  },
  {
    id: 14,

    songName: ` Rao Sahab Ka Chora
        <br>
        <div class="subtitle"></div>`,
    poster: "img/haryanvi/14.png",
  },
  {
    id: 15,

    songName: `System Pai System

        <br>
        <div class="subtitle">
        </div>`,
    poster: "img/haryanvi/15.png",
  },
  {
    id: 16,
  ...
  },
  {
    ...
    songName: `Ladoo
        <br>
        <div class="subtitle"></div>`,
    poster: "img/haryanvi/17.png",
  },
  {
    id: 18,

    songName: `Jail Karawegi re Chori
        <br>
        <div class="subtitle"></div>`,
    poster: "img/haryanvi/18.png",
  },
  {
    id: 19,

    songName: ` Pani Chalke
        <br>
        <div class="subtitle"></div>`,
    poster: "img/haryanvi/19.png",
  },
  {
    id: 20,
...
const tilePlayer = (isPaused = true) => {
  if (index !== previndex) {
    music.src = `audio/haryanvi/${index}.mp3`; // Corrected the src path
    previndex = index;
  }
  poster.src = `img/haryanvi/${index}.png`; // Corrected the src path
