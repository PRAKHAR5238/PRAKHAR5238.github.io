const music = new Audio("audio/arjitsong/12.mp3");
let index = 24;
let previndex = 24;
...
const song = [
  {
    ...
    songName: `Tum hie hoe
        <br>
        <div class="subtitle">Arjit Singh</div>`,
    poster: "img/arjits/1.png",
  },
  {
    id: 2,

    songName: `  Apna bana lue
    
        <br>
        <div class="subtitle">Arjit Singh</div>`,
    poster: "img/arjits/2.png",
  },
  {
    id: 3,
    ...
    songName: `Chaleya
        <br>
        <div class="subtitle">Arjit Singh
</div>`,
    poster: "img/arjits/3.png",
  },
  {
    id: 4,
    ...
    poster: "img/arjits/4.png",
  },
  {
    id: 5,

    songName: `Pyar hota kayi bar hai
        <br>
        <div class="subtitle">
       Arjit Singh
        </div>`,
    poster: "img/arjits/5.png",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    poster: "img/arjits/7.png",
  },
  {
    id: 8,

    songName: `Tum kyu Mile
        <br>
        <div class="subtitle">Arjit Singh</div>`,
    poster: "img/arjits/8.png",
  },
  {
    id: 9,

    songName: `Phir bhi tumkoi Chaunga
        <br>
        <div class="subtitle">Arjit Singh </div>`,
    poster: "img/arjits/9.png",
  },
  {
    id: 10,
  ...
  },
  {
    ...
    poster: "img/arjits/12.png",
  },
  {
    id: 13,

    songName: `Pal Pal dil kai Pass
        <br>
        <div class="subtitle">Arjit Singh</div>`,
    poster: "img/arjits/13.png",
  },
  {
    id: 14,

    songName: ` Mann Jogiya
        <br>
        <div class="subtitle">Arjit Singh</div>`,
    poster: "img/arjits/14.png",
  },
  {
    id: 15,

    songName: `Phir aur Kya Chaiye

        <br>
        <div class="subtitle">Arjit Singh
        </div>`,
    poster: "img/arjits/15.png",
  },
  {
    id: 16,

    songName: `Ager tum sath hoe
        <br>
        <div class="subtitle">Arjit Singh </div>`,
    poster: "img/arjits/16.png",
  },
  {
    id: 17,
  ...
  },
  {
    ...
    songName: `Zaalima
        <br>
        <div class="subtitle">Arjit Singh</div>`,
    poster: "img/arjits/18.png",
  },
  {
    id: 19,

    songName: `Aee Dil hai Muskil
        <br>
        <div class="subtitle">Arjit Singh</div>`,
    poster: "img/arjits/19.png",
  },
  {
    id: 20,
...
const tilePlayer = (isPaused = true) => {
   if(index !== previndex){
     music.src = `audio/arjitsong/${index}.mp3`; // Corrected the src path
     previndex = index;
   }
    poster.src = `img/arjits/${index}.png`; // Corrected the src path
