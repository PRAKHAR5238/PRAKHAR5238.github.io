const music = new Audio("audio/honey/9.mp3");
let index = 24;
let previndex = 24;
...
const song = [
  ...
  },
  {
    ...
    songName: `Dope Shope
        <br>
        <div class="subtitle">Honey Singh
</div>`,
    poster: "img/honey/3.png",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    poster: "img/honey/7.png",
  },
  {
    id: 8,

    songName: `Fugly Fugly
        <br>
        <div class="subtitle">Honey Singh</div>`,
    poster: "img/honey/8.png",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    songName: `Sunny Sunny
        <br>
        <div class="subtitle">Honey Singh </div>`,
    poster: "img/honey/10.png",
  },
  {
    id: 11,

    songName: ` Chaar Bottle Vodka
        <br>
        <div class="subtitle">Honey Singh</div>`,
    poster: "img/honey/11.png",
  },
  {
    id: 12,
  ...
  },
  {
    ...
    poster: "img/honey/15.png",
  },
  {
    id: 16,

    songName: `Party All Nights
        <br>
        <div class="subtitle">Honey Singh </div>`,
    poster: "img/honey/16.png",
  },
  {
    id: 17,
...
const tilePlayer = (isPaused = true) => {
   if(index !== previndex){
     music.src = `audio/honey/${index}.mp3`; // Corrected the src path
     previndex = index;
   }
    poster.src = `img/honey/${index}.png`; // Corrected the src path
...
Array.from(document.getElementsByClassName("playlist_play")).forEach((e) => {
  e.addEventListener("click", (el) => {
    ...
    download.href=`audio/honey/${index}.mp3`
  });
});
